return {
    ...
    opts = function(_, opts)
        ...
        opts.winbar = { -- winbar
            ...
            fallthrough = false, -- pick the correct winbar based on conditiona
            {
        ...
        opts.tabline = { -- tabline
            { -- file tree padding
                ...
                provider = function(self)
                    local title_text = "Explorer"
                    local width = self.winwidth - title_text:len()
                    return (" "):rep(width / 2) .. title_text .. (" "):rep(width / 2)
                end,
                hl = { bg = "tabline_bg", bold = true },
            },
